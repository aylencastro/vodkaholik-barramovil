    ...
    <footer> 
        <div class="footer-text">
            ...
            <p><a href="https://www.instagram.com/refill_barramovil/" target="_blank"><img src="./icon/iconfinder_square-facebook_317727.png" alt="" class="instagram"> &nbsp; refill_barramovil</a></p> <!-- Facebook | poner el link a la página de fb, por ahora lleva a instagram -->
            <br>
            <hr>
            <h3>CONTACTO</h3>
